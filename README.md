...
- **Spacecraft** — find famous probes and satellites still in the Solar System, from Parker Solar Probe and the ISS out to **Voyager 1**. Planets stay on the map but grayed. The map keeps Voyager past Neptune but packs the outer system so the whole set fits the first view. After you pick Spacecraft, choose all of them, pick destinations (Earth, Mars, outer system, and more), and optionally **Include historic missions** for Pioneer, Cassini, Galileo, and others. Earth has thousands of satellites; this mode is the well-known missions you can learn on the map.
